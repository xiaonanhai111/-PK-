...
pytesseract.pytesseract.tesseract_cmd = r'E:\download\tesseractAPP\tesseract.exe'
...
def process_questions():
    ...
    while running:
        ...
        # image.save("E:/download/png/1.png")
        ...
        roi = image[300:500, 700:1200]  # 请根据实际的数字位置调整
        ...
        if len(matches) >= 2:
            ...
            if (num1, num2) == previous_numbers:
                ...
                draw_thread.start()  # 非阻塞式
                draw_thread.join()  # 等待绘图完成  阻塞式
